...
import { LayoutDashboard, Users, Info, Map, Activity, Swords, Sparkles } from 'lucide-react';
...
export default function App() {
  ...
  const selectedEntity = selectedEntityId ? mockEntities.find(e => e.id === selectedEntityId) : undefined;
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button 
              ...
              className={`px-4 py-2 rounded-lg font-mono text-sm transition-colors flex items-center gap-2 ${currentPage === 'logs' ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-slate-200 hover:bg-white/5'}`}
            >
